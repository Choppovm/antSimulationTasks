...
def Main():         #Q1
    ...
    SimNo = GetSimChoice() # TASK 4b CHANGE
    if SimNo == "1":
...
def DisplaySimulationChoices():
    print("Simulation 1:\n- Grid: 5x5 (Nest(s): 1)\n- Ant(s): 5 (Queen Ant(s): 1, Worker Ant(s): 4)\n- Food units: 500 (Grid Food Source(s): 3)\n- Pheromone strength: 1000 (Pheromone Decay Rate: 50)\n")
    print("Simulation 2:\n- Grid: 5x5 (Nest(s): 1)\n- Ant(s): 5 (Queen Ant(s): 1, Worker Ant(s): 4)\n- Food units: 500 (Grid Food Source(s): 3)\n- Pheromone strength: 1000 (Pheromone Decay Rate: 100)\n")
    print("Simulation 3:\n- Grid: 10x10 (Nest(s): 1)\n- Ant(s): 9 (Queen Ant(s): 1, Worker Ant(s): 8)\n- Food units: 500 (Grid Food Source(s): 3)\n- Pheromone strength: 1000 (Pheromone Decay Rate: 25)\n")
    print("Simulation 4:\n- Grid: 10x10 (Nest(s): 2)\n- Ant(s): 6 (Queen Ant(s): 1, Worker Ant(s): 5)\n- Food units: 500 (Grid Food Source(s): 3)\n- Pheromone strength: 1000 (Pheromone Decay Rate: 25)\n")
    return
...
def GetSimChoice():
    ...
    while not simChosen:
        try:
            ...
            simChoice = int(input("Enter desired simulation number\nType the number 0 to redisplay the available options.\n> "))
            if simChoice not in validChoices:
                simChosen = False
                print("\nPlease enter a valid simulation choice (1, 2, 3, or 4)\n")
            elif simChoice == 0:
                DisplaySimulationChoices()
            else:
                simChosen = True
            ...
            print(f"\nPlease enter numerical characters only.\n(Error Details: '{vee}')\n")
    return simChoice
# TASK 4b CHANGE
